...
public class Constants {
    ...
    public static final String TRANSACTION_HISTORY_FILE_PATH = "src/main/resources/transaction_history.txt";
    public static final String TRANSACTION_BALANCES_FILE_PATH = "src/main/resources/transaction_balances.txt";
